...
public class WorkQueue {
	...
	/** The lock used for synchronizing access to pending */
	...
	public void execute(Runnable r) {
		...
		synchronized (queue) {
			queue.addLast(r);
			queue.notifyAll(); // notify waiting threads that new work is available
		}
	}
	...
	/**
	 * Increments the pending variable to signal there's work being done.
	 */
	...
	/**
	 * Decrements the pending variable to signal there's work that has finished.
	 */
